...
// 변수명 = 할당할 데이터
//message = "Hello World!"; // "Hello World!" 데이터를 저장한 공간의 이름이 message, 변수 message에 "Hello World!"를 할당
...
//message5 = "Hello"; // 오류 발생

// let VS const
// let : 변하는 데이터를 저장하는 변수
// const : 변하면 안되는 데이터를 저장하는 변수 선언 방식

// 대소문자 구분하기 때문에 아래 두 변수는 다른 변수
let message;
let MESSAGE;
